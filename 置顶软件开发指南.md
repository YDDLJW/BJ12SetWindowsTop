...
- 在[官网](https://nodejs.org/zh-cn)下载并安装node.js
- 在系统命令行运行以下命令检查是否安装以及安装版本
    ```bash
    node -v
    npm -v
    ```
- 在系统命令行运行以下命令安装electron
    ```bash
    npm install -g electron
    ```
- 在系统命令行中运行以下命令检查是否安装以及安装版本
    ```bash
    electron --version
    ```
  ...
  - 示例
    ...
    [
      ...
      },
      {
          "id": 4,
          "name": "Window4",
          "notes": "Background process window"
      }
    ]
    ```
